document.addEventListener('DOMContentLoaded', function() {
    ...
    if (dynamicRoleSpan) {
      const titles = ["Data Analytics", "AI/ML Development", "Data Engineering", "Web Development"];
      let titleIndex = 0;
      const typeSpeed = 70;
    ...
    const projects = [
         ...
         {title: "Sentiment Analysis API",description: "Created a real-time sentiment classification system for product reviews using NLP techniques and deployed as a Flask API service.",tags: ["NLP", "Flask", "NLTK", "BERT"],image: "Gemini_Generated_Image_j24m0wj24m0wj24m.jpg",link: "#"}, // Placeholder Link
         ...
         {title: "Image Classification",description: "Built a CNN model for image classification using transfer learning with ResNet50, achieving 98% accuracy on test data.",tags: ["Python", "TensorFlow", "CNN", "Computer Vision"],image: "Gemini_Generated_Image_kd4l3fkd4l3fkd4l.jpg",link: "#"} // Placeholder Link
     ];
    ...
    const skills = [
      ...
      { name: "DBMS", icon: "fas fa-database" }, // Using same icon as MySQL
      ...
      { name: "Pandas", icon: "fas fa-table" }, // Representing dataframes
      { name: "Power Query", icon: "fas fa-filter" }, // Representing data transformation
      { name: "DAX Query", icon: "fas fa-percentage" }, // Representing DAX calculations
      ...
      { name: "NumPy", icon: "fas fa-calculator" } // Representing numerical operations
    ];
